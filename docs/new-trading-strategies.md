...
|----------|--------|--------------|------------------|-------------------|--------|
| Smart Money Multi-Wallet Convergence | Active paper-trade strategy | Multiple watched wallets converge on the same market/outcome | `min_wallets`, confidence threshold, include/exclude keywords, holder-wallet exception, price `0.05-0.95`, 14-day horizon | 10-minute confirmation queue, anti-hedge, group limit, daily cap, 72h near-resolution guard | `evaluate_triggers`, `cmd_monitor` |
